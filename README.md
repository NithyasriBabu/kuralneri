...
**Kuralneri** is a sophisticated, private, and graceful interface for the _Thirukkural_. More than a digital library, it serves as an **Autonomous Moral Guide (Guru)**—an offline AI companion that interprets 2,000-year-old Tamil wisdom to navigate modern life’s complexities.
...
- **Tamil:** _Mukta Malar_ (Variable weight for anti-glow in dark mode).
- **English/Modern:** _Inter_ (Medium 500 for crisp readability).
...
> _"To discern the truth in everything, by whomsoever spoken, is wisdom."_ — **Kural 423**
